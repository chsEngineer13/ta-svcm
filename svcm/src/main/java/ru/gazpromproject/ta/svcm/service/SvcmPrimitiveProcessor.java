...
public class SvcmPrimitiveProcessor implements PrimitiveProcessor {
    ...
    public void readPrimitive(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType responseFormat)
        ...
        SvcmEntityStorage entityRepository = new SvcmEntityStorage(odata, serviceMetadata.getEdm());
        Entity entity = entityRepository.readEntityData(edmEntitySet, keyPredicates);
